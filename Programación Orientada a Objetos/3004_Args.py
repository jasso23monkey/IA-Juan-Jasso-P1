...
class Luchador:
    ...
    def presentar_logros(self):
        """Muestra los logros del luchador en un formato de lista."""
        if self.logros:
...
def crear_luchador():
    ...
    logros = input("Ingrese los logros del luchador: ")
    
    # Crea la instancia de la clase Luchador con los datos ingresados
    return Luchador(nombre, fuerza, tecnica, agilidad, carisma, tipo, logros)
